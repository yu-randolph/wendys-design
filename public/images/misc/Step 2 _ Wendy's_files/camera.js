...
;(function($){$.fn.camera = function(opts, callback) {
	...
	for (loopMove=0;loopMove<amountSlide;loopMove++)
	{
		...
		if(allLinks[loopMove]!=''){
			...
			//
			$('.camera_target_content .cameraContent:eq('+loopMove+')',wrap).append('<a class="" href="'+allLinks[loopMove]+'" '+dataBox+' target="'+allTargets[loopMove]+'"><img src="../images/btnOrderNow.png" class="btnOrderNow-desktop" /></a>');
		}
